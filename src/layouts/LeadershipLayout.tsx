...
function useActiveRoute() {
  ...
  if (pathSegments[1] === 'leadership') {
    const subPath = `/leadership/${pathSegments[2] || ''}`;
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="h-16 px-6 flex items-center gap-3 hairline-b bg-white shrink-0">
        <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-ocean to-primary flex items-center justify-center">
          <Award className="w-5 h-5 text-white" />
        </div>
        <div>
          <div className="text-base font-medium text-primary tracking-tight leading-none">EduPortal</div>
          <div className="text-[11px] text-text-secondary mt-1 leading-none">Ban Giám Hiệu</div>
        </div>
      </div>
    ...
    <>
      ...
      <div className="min-h-screen flex bg-[#F8F9FB]">
        ...
        <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-white border-b border-hairline">
          <div className="flex items-center justify-between h-14 px-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-ocean to-primary flex items-center justify-center">
                <Award className="w-4 h-4 text-white" />
              </div>
              <span className="font-medium text-primary">Ban Giám Hiệu</span>
            </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 pt-14 lg:pt-0">
          ...
          <Header searchPlaceholder="Tìm giáo viên, báo cáo, phê duyệt..." />
          <main
            id="main-content"
