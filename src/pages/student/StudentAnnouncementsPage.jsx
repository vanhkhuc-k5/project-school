    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="secondary" size="sm" icon={RefreshCw} onClick={fetchAnnouncements} disabled={loading}>
            Làm mới
          </Button>
        </div>
      </div>
          ...
          {[1, 2, 3].map((i) => (
            <Card key={i} padding="p-6" className="animate-pulse">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-hairline rounded-full shrink-0"></div>
                <div className="flex-1 space-y-2">
                  <div className="h-4 bg-hairline rounded w-3/4"></div>
                  <div className="h-3 bg-hairline rounded w-full"></div>
